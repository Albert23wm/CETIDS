...
<body>
  ...
  $query = "SELECT nombre FROM estudiantes WHERE matricula = ?";
  ...
  <header
    ...
    <div class="col-12 col-md-6 mb-2 text-center mb-md-0">
      ...
      <h5 class="text-white "><b>RECONOCIMIENTOS</b></h5>
        ...
        <div class="container marketing text-center">
          ...
          <div class="row justify-content-center">
            ...
            <div class="alert alert-success alert-dismissible fade show" role="alert">
              ...
              <h5><b>¡GRACIAS POR ASISTIR AL CONGRESO ESTATAL DE TECNOLOGÍAS DE LA INFORMACIÓN E INGENIERÍA EN
                  DESARROLLO Y GESTIÓN DE SOFTWARE 2024!</b></h5><br> En este apartado se reflejará tu reconocimiento
              por tu asistencia en este evento.
            ...
            <div class="card"
              ...
              <div class="card-body">
                ...
                <form action="../controllers/estudiantes/generarReconocimiento.php" method="POST">
